...
class SearchResultTestCase(TestCase):
    def test_init(self):
        ...
        self.assertEqual(no_data_sr.verbose_name, u'Mock model')
        ...
        self.assertEqual(extra_data_sr.verbose_name, u'Mock model')
        ...
        self.assertEqual(no_overwrite_data_sr.verbose_name, u'Mock model')
